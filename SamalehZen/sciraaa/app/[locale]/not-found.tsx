...
import { LocalizedLink } from '@/components/i18n/link';
  ...
  return (
    <div className="flex flex-col font-sans items-center justify-center min-h-screen bg-background text-foreground p-4">
      ...
      >
        ...
        <h1 className="text-4xl mb-4 text-neutral-800 dark:text-neutral-100 font-be-vietnam-pro">{t('notFound.title')}</h1>
        <p className="text-lg mb-8 text-neutral-600 dark:text-neutral-300">{t('notFound.description')}</p>

        <div className="flex justify-center">
          <LocalizedLink href="/new">
