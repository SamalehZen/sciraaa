...
export default function AdminHomePage() {
  ...
  const globalHealthStatus = health?.globalStatus || 'unknown';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
              ...
              <Card className="p-4">
                ...
                <div className="text-2xl font-semibold">
                  {globalHealthStatus === 'ok' && <span className="text-green-500">✓ OK</span>}
                  {globalHealthStatus === 'warn' && <span className="text-yellow-500">⚠ Warning</span>}
                  {globalHealthStatus === 'down' && <span className="text-red-500">✗ Down</span>}
                  {globalHealthStatus === 'unknown' && <span className="text-muted-foreground">—</span>}
                </div>
                <div className="text-xs text-muted-foreground mt-1">Latence moy: {avgLatency.toFixed(0)}ms</div>
              </Card>
            </div>
          </div>
