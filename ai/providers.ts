...
// Arka backend: single provider mapping via OpenRouter.
// Default model is google/gemini-2.0-flash-exp:free via OpenRouter
...
function getOpenRouterProvider() {
  if (!OPENROUTER_API_KEY) {
    console.warn('OPENROUTER_API_KEY not set, API calls will fail');
  }
