export const LIBELLER_PROMPT = `RÔLE ET OBJECTIF :
...
Suppression des caractères spéciaux : Scannez le libellé et supprimez tous les caractères qui ne sont PAS des lettres (A-Z), des chiffres (0-9), un espace ( ) ou une virgule (,). Cela inclut les accents (é, è, à -> E, E, A), les apostrophes ('), les tirets (-), etc.
