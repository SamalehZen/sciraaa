...
export const generatePdfFromMarkdown = async (options: PdfExportOptions): Promise<void> => {
  ...
  const pdfHtml = `
    <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 100%; color: #1a1a1a; line-height: 1.6;">
      <!-- Header -->
      ...
      <!-- Main Title -->
      <h1 style="font-size: 24px; font-weight: 700; color: #1a1a1a; margin-bottom: 24px; line-height: 1.3;">
        ${title}
      </h1>
