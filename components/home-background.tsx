...
try {
  ...
  console.error('Failed to initialize DotMaterial:', err)
}
...
function Scene() {
  ...
  const dotMaterial = useMemo(() => {
    if (!DotMaterial) return null
    return new DotMaterial()
  }, [])

  useEffect(() => {
    if (!dotMaterial) return
  ...
  if (!dotMaterial || !DotMaterial) return null
