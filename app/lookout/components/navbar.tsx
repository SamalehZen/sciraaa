      ...
      <div className="flex items-center gap-2">
        {isProStatusLoading ? (
          ...
          <div className="pointer-events-auto">
            <span className="font-baumans! inline-flex items-center gap-1 rounded-lg shadow-sm border-transparent ring-1 ring-sky-500/40 dark:ring-sky-300/40 ring-offset-1 ring-offset-background bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-600 text-white px-2.5 pt-0.5 pb-2 sm:pt-1 leading-3 dark:bg-gradient-to-r dark:from-sky-400 dark:via-blue-500 dark:to-indigo-500 dark:text-white">
              <span>Fix</span>
            </span>
          </div>
        ) : null}
