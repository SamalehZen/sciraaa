  ...
  const dataStream = createUIMessageStream<ChatMessage>({
    execute: async ({ writer }) => {
      ...
      if (String(group) === 'libeller') {
        ...
        const leakingAsk = askText.includes('prompt complet') || askText.includes('exact prompt') || askText.includes('full prompt') || askText.includes('regles exactes') || askText.includes('règles exactes') || askText.includes('show prompt') || askText.includes('montrer les regles') || askText.includes('montrer les règles') || askText.includes('afficher les regles') || askText.includes('afficher les règles');
